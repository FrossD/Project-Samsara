...
Phenomena attacks such as extreme heat and cold, electricity, vibration (shockwaves) etc. also constitute a threat to a lattice. They introduce unwanted information into equations, and cause the resulting folded Chalk to be distorted.
...
- **Deep Hollow**
	...
	The power of a summoned Hollow depends on the conviction of the caster, and thus these hollows come in three tiers, escalating in power, splendor and gaining new functions as they grow.
...
A **Cast** is a broad term applied to any Strider power that is generally defined by exclusivity or complexity. A Strider 'casts' their Tek, 'casts' with their relic, and 'casts' rituals. If an ability is granted by a [[The Cyclicality of Names#Strider Titles and Titular Powers|title]], it is 'casted' as well. A Strider is said to be 'preparing a cast' if they are winding up to use one of these abilities. Unlike Weaves, Casts typically have 'cooldowns', or some constraint that prevents them from having constant uptime - unless otherwise stated.
...
#### Example: FSword
- T1 - Relic Armaments
	- Martial Arm - 1530 Centigrade
	- Martial Arm - Parrying Vault Relic
	- Firearm - None
- T2 - Elementary Calcic
	- Strike - Echostrike
	- Charge - Sun Spear 
	- Shield - Lightrigger Parry/Praxis Counter (P)
	- Dash - 
	- ~~Armament~~
- T3 - Advanced Calcic
	- Tek - Sunfire Gauge
	- ~~Qui~~
- T4 - Grand Calcic
	- Grand Ritualism - Eastern Trade Winds
- T5 - Flash Protocol
